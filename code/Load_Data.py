...
- writes out the tweets as a JSON file into the ../data/ folder
'''

import json

tweet_input_file_name = input('Enter the twitter file name (excluding file type ending):  ')
tweets_data = '../data/%s.txt' %(tweet_input_file_name)
...
# Write out JSON File:
tweet_file_name_out = '%s_output' %(tweet_input_file_name)
